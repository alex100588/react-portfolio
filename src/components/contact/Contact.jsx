        ...
        <div id='contact' className="contact">
            ...
            <div className="contact-section">
                ...
                <form onSubmit={onSubmit} className='contact-right'>
                    ...
                    <input value={input} type="text" placeholder='Enter your name' name='name' />
                    <label htmlFor="">Your Email</label>
                    <input value={input} type="email" placeholder='Enter your email' name='email'/>
                    <label htmlFor="">Write your message here:</label>
                    <textarea value={input} name='message' rows='8' placeholder='Enter your message'></textarea>
